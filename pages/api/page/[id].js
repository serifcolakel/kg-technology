...
let pages = [
  {
    type: 1,
    name: "KG Teknoloji - Hakkımızda",
    url: "/hakkimizda",
    html: `
    <p>KG Teknoloji bilgi teknolojileri sektöründeki bilgi birikimi ve deneyimleri 2003 yılına dayanır. Gücünü tecrübesinden alan KG Teknoloji ekibi, çalışmalarınızda daha etkili sonuçlar almayı sağlamak için size rehberlik eder. Müşterilerine en kaliteli hizmeti yüksek verimle ve değişen dünyaya uyum sağlayan hızda sunmak; onlarla güven esaslı ilişkiler kurmak ve alanında uzman 300’ün üzerinde çalışanlarının yeteneklerini rahatça yansıtabildiği bir çalışma ortamı sağlamak KG Teknoloji’nin vazgeçilmez değerleridir. Dinamik ve çözüm odaklı bir yaklaşımla müşterilerine artı değer katarken onların verimliliklerini ve büyüme oranlarını artırmak ise öncelikli hedefleridir.</p>
    <p>KG Teknoloji, büyük ölçekli şirketlere anahtar teslim projeler, süreç yönetim danışmanlığı ve scorecard bazlı yönetilen (managed services) hizmetleri verirken müşteri odaklı yaklaşımıyla dış kaynak (outsourcing) hizmeti de sağlar. Maliyet etkinliğini daima en üst düzeyde tutmayı amaçlayan KG Teknoloji, kalite güvencesi ve destek hizmetler ile kurumunuza en uygun olan çözümü talepleriniz doğrultusunda sunar. Gelir arttıran, şirketinize prestij katan, müşterinizin memnuniyetini arttıran, tasarruf yaratan ve riskleri en aza indiren projeleri oluştururken yeni teknolojinin tüm araçlarını da kullanır.</p>
    <p>KG Teknoloji, dört çalışma modelini benimser. Bunlar KPI Bazlı Yönetilen Hizmetler (Managed Services), Proje Bazlı Anahtar Teslim Hizmetler, Danışmanlık Hizmetleri ve Dış Kaynak Hizmetleri (Outsourcing Services) ’dir.</p>
    <p>KG Teknoloji, Faturalama ve Ücretlendirme, Müşteri İlişkileri ve Yönetimi, İş Zekası, Ara Katman, Katma Değerli Servisler alanlarında Yazılım Geliştirme, Test Mühendisliği, İş ve Sistem Analizi, Proje Yönetimi, Operasyon Destek, Kurumsal Mimari, Sürüm ve Konfigürasyon Yönetimi başlıklarında tecrübeli kaynaklarıyla ve hedef odaklı dinamik yaklaşımıyla hizmet vermektedir.</p>
    <p>KG Teknoloji deneyimli kadrosu, yarattığı istihdam, BT’nin her alanındaki yetkinliği ve çözüm odaklı yaklaşımı ile katkıda bulunduğu sektörün öncü isimlerinden biridir.</p>
`,
    imgUrl: "https://www.kgteknoloji.com/images/img/hakkimizda.jpg",
  },
  {
    type: 1,
    name: "KG Teknoloji - Yazılım Geliştirme",
  ...
  {
    type: 1,
    name: "KG Teknoloji - Test Mühendisliği",
    url: "/test-muh",
    html: `
  ...
  {
    type: 1,
    name: "KG Teknoloji - İş ve Sistem Analizi",
  ...
  {
    type: 1,
    name: "KG Teknoloji - Proje Yönetimi",
    url: "/proje-yonetimi",
...
`,
  ...
  {
    type: 1,
    name: "KG Teknoloji - Operasyon Destek",
...
`,
  ...
  {
    type: 1,
    name: "KG Teknoloji - Sürüm - Konfigürasyon Yönetimi",
...
`,
  ...
  {
    type: 1,
    name: "KG Teknoloji - Kurumsal Mimari",
    url: "/kurumsal-mimari",
...
`,
  ...
  {
    type: 1,
    name: "KG Teknoloji - Sistem Entegrasyon",
...
`,
  ...
  {
    type: 2,
    name: "KG Teknoloji - KPI Bazlı Yönetilen Hizmetler",
...
`,
  ...
  {
    type: 2,
    name: "KG Teknoloji - Dış Kaynak Hizmetleri",
